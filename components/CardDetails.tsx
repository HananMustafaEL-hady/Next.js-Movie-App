...
import styles from "../styles/CardDetails.module.css"
  ...
  return <div className={`card text-center border-0 mx-auto d-flex ${styles.widthCard}` }>
  <div className="card-img-top">
  <Image className={` ${styles.widthCard} `} 
   width={500}
   height={500}src={`https://image.tmdb.org/t/p/w400${movie.poster_path}`} alt="Card image cap"></Image>
  </div>
